...
class TicketView(ViewSet):
    ...
    def update(self, request, pk=None):
        ...
        Returns:
            Response -- No response body. Just 204 status code in the return.
        """
...
class TicketSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ServiceTicket
        fields = ('id', 'customer', 'employee', 'description', 'emergency', 'date_completed', 'employee', 'customer',)
        depth = 1
        # Expands the foreign keys of employee and customer